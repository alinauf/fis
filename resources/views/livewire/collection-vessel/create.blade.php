...
>
    ...
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Create Collection Vessel') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __("Create a new collection vessel") }}
        </p>
    </header>

    <form action="{{url("collection-vessel")}}" method="POST">
        @csrf
        ...
        <x-confirm-create-modal title="Are you sure"
                                subtitle="Please confirm if you would like to create the collection vessel"/>
    </form>
</div>
